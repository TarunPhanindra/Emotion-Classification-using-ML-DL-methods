...
class Trainer:
    ...
    def __init__(self, X, y, X_test, y_test, batch_size, learning_rate, epochs, k_folds=5, results_file="results_ERCnnBiLstm_32.txt"):
        self.X = X
        self.y = y
        self.X_test = X_test
        self.y_test = y_test
    ...
    def plot_confusion_matrix(self, conf_matrix, fold_index):
        ...
        plt.ylabel("True")
        plt.savefig(f"confusion_matrix_best_validation_fold_ERCnnBiLstm_32_{fold_index + 1}.png")  # Save the plot as a PNG file with a descriptive name
        plt.show()
    ...
    def plot_training_validation_accuracies(self, train_accuracies, val_accuracies):
        ...
        plt.savefig("training_vs_validation_accuracies_ERCnnBiLstm_32.png")
        plt.show()
